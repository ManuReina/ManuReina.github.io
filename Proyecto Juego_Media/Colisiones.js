 ...
 * una caja 2D.
*/
function collidePointBox(spriteID1, spriteID2) {
	...
	var X2Max = X2 + spriteID2.Width;
	var Y2Max = Y2 + spriteID2.Height;
...
*/
function collideBoxes(spriteID1, spriteID2) {
	// variables del primer objeto
	var X1 = spriteID1.X;
	var Y1 = spriteID1.Y;
	// variables del segundo objeto
	...
	var X1Max = X1+ spriteID1.Width;
	var Y1Max = Y1 + spriteID1.Height;
	// ancho y alto del segundo objeto
	var X2Max = X2 + spriteID2.Width;
	var Y2Max = Y2 + spriteID2.Height;
